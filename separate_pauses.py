...
input_file_path = 'activities.geojson'
activities = load_geojson(input_file_path)

# Split the activities at points with large gaps
new_activities = split_activities(activities, threshold_km=0.5)

# Save the new activities to a new GeoJSON file
output_file_path = 'split_activities.geojson'
save_geojson(new_activities, output_file_path)

print("New activities saved to", output_file_path)
